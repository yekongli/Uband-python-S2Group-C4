...
#     recall_list = []
#     for val in volcaulay_list:
#         recall_list.append(val[0])
#         recall_list.append(val[3])
#     return recall_list

# #设置每日单词数量
# def set_amount(volcaulay_list):
#     set_list = []
#     index = 0
#     if index　< len(volcaulay_list):
#         set_list.append(volcaulay_list[index:index+num_words])
